...
public class RowLayoutManager extends RecyclerView.LayoutManager {
    private static final String TAG = RowLayoutManager.class.getSimpleName();
    ...
    // This allows Row to layout only a fixed number of rows, any views from further rows
    // will remain detached and therefore hidden
    private int mRowsLimit = -1;

    private GreedoLayoutSizeCalculator mSizeCalculator;

    public RowLayoutManager(SizeCalculatorDelegate sizeCalculatorDelegate) {
