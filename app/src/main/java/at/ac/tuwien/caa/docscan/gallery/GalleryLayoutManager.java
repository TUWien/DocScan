...
public class GalleryLayoutManager extends RecyclerView.LayoutManager {
    ...
    public GalleryLayoutManager(GalleryLayoutSizeCalculator.SizeCalculatorDelegate sizeCalculatorDelegate) {
        mSizeCalculator = new GalleryLayoutSizeCalculator(sizeCalculatorDelegate);
    }
    ...
    public GalleryLayoutSizeCalculator getSizeCalculator() {
